 ...
 * Broadcom FullMAC WiFi driver register definitions
 */
...
#define BWFM_CHANSPEC_D11N_SB_L			(0x1 << 8)
#define BWFM_CHANSPEC_D11N_SB_U			(0x2 << 8)
#define BWFM_CHANSPEC_D11N_SB_N			(0x3 << 8)
...
#define BWFM_BCDC_FLAG_SUM_GOOD		(1 << 2)
#define BWFM_BCDC_FLAG_SUM_NEEDED	(1 << 3)
	uint8_t priority;
